...
sendOrder(m.chat, teks, "391028153034238", fs.readFileSync('./worker/media/image/Deff.jpg'), 2022, "Ryutenzo~MD", "6289501060783@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
url: 'https://instagram.com/ryutenzo_'
}
}, {
quickReplyButton: {
displayText: '📈Status',
...
sock.sendMessage(from, { caption: listmn, location: { jpegThumbnail: fs.readFileSync('./worker/media/image/loc.jpg') }, buttons: but, footer: '©Ryutenzo'})
}
break
break
case prefix+'gura':
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(i, txt, "© Ryutenzo", log0, btn, thum)
}
...
let txt = `*「 Broadcast」*\n\n${text}`
sock.send5ButImg(yoi, txt, "© Ryutenzo", log0, btn, thum)
}
...
teks = `「 Ryutenzo ~ MD」\nhttps://telegra.ph/file/9840e0f52e51755f30802.jpg`
...
title:"Ryutenzo ~ MD Qris ( Donate )",
body: "©Ryutenzo", 
thumbnail: fs.readFileSync("worker/media/image/Deff.jpg"),
mediaType:1,
mediaUrl: 'https://telegra.ph/file/9840e0f52e51755f30802.jpg',
sourceUrl: "https://telegra.ph/file/9840e0f52e51755f30802.jpg"
}}
}
sock.sendMessage(m.chat, buttonMessage, { quoted: m })
}
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./worker/media/image/Deff.jpg'), 2022, "Ryutenzo~MD", "6289501060783@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await sock.groupAcceptInvite(vcc).then(async(res) => ads(jsonformat(res))).catch(_ => _)
ads("Succes")
} else {
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Ryutenzo - By Lucyfxr",
body:"© Ryutenzo",
thumbnail: log0,
mediaType:2,
mediaUrl: "http://botwa.rf.gd/",
sourceUrl: "http://botwa.rf.gd/"
}}
}
sock.sendMessage(m.chat, buttonMessage, { quoted: m })
